...
RUN wget -O master.zip https://github.com/TechXueXi/TechXueXi/archive/refs/heads/master.zip; mkdir xuexi;unzip master.zip;cp -r ./TechXueXi-master/SourcePackages/* /xuexi; cp ./TechXueXi-master/requirements.txt /xuexi
